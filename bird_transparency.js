...
function drawDrinkingBird() {
    ...
    //var glassMaterial = new THREE.MeshPhongMaterial( { transparent: true, color: 0xFFFFFF, shininess: 100 } );
    var glassMaterial = new THREE.MeshPhongMaterial( { shininess: 100, transparent: true, opacity: 0.3, color: 0x000000, specular: 0xFFFFFF} );
